...
```{r}
save(dat_features, dat_job, adj, file=file.path(datadir, "dat_job_adjMatrix_fulldata.RData"))
```


```{r}
save(dat_job, adj, file=file.path(datadir, "dat_job_adjMatrix_subset2.RData"))
